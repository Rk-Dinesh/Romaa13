    ...
    <div className="font-roboto-flex flex flex-col h-full">
      ...
      <div className="mt-4 overflow-y-auto no-scrollbar">
        <table className="w-full text-sm whitespace-nowrap">
          <thead>
            <tr className="font-semibold text-sm dark:bg-layout-dark border-b-4 dark:border-border-dark-grey bg-white border-light-blue">
          ...
          <tbody className="text-greyish dark:text-gray-200">
            {data.map((item, index) => (
              <React.Fragment key={index}>
                {/* MAIN ROW */}
                <tr className="border-b-[3px] text-center dark:bg-layout-dark bg-white">
