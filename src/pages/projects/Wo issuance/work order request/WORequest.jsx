    ...
    const fetchData = async () => {
      try {
        const res = await axios.get(
          `${API}/workorderrequest/api/getbyId/${projectId}`
        );
    ...
    <>
                            ...
                            <p
                              onClick={() => {
                                setSelectedContext({
                                  ...
                                  tenderId: projectId,
                                  vendors: item.vendorQuotations || [],
                                });
                                setShowVendorModal(true);
                              }}
                              className="cursor-pointer bg-darkest-blue text-white p-1.5 rounded"
                              title="Select Vendor"
                            >
                              <FaUsers />
                            </p>
                                      ...
                                      <table className="w-full text-xs border-t">
                                        ...
                                        <tbody>
                                          ...
                                          <tr className="bg-gray-100 dark:bg-slate-800 font-semibold">
                                            <td
                                              colSpan="5"
                                              className="text-right border px-2 py-1"
                                            >
                                              Total
                                            </td>
      ...
      {showVendorModal && (
        <VendorRequestModal
          ...
          vendors={selectedContext.vendors}
          requestid={selectedContext.requestId}
          tenderId={selectedContext.tenderId}

          // onSubmit={} // You can add this prop if needed
        />
      )}
    </>
  );
